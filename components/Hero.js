...
export default function Hero() {
  ...
  return (
    ...
    <div className="flex flex-row justify-center items-start overflow-hidden px-6 mt-12 pb-38 bg-mainBlack">
      <div className="flex flex-col w-full lg:w-6/12 px-12 md:px-24">
        ...
        <h1 className="font-bold text-4xl mb-3 md:text-6xl text-green-400">I mess around with things for fun.</h1>

  ...
  return (
    <div>
      <div className="max-w-6xl mx-auto px-4 py-10 md:pt-20">
          ...
          <div className="w-1/2 flex justify-evenly pb-12 lg:w-1/4">
            ...
            >
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-spotify w-5 h-5"
                viewBox="0 0 16 16"
              >
        ...
        {/* <div className="flex flex-col items-center space-y-4 md:space-y-0 md:flex-row justify-between md:items-center mt-8">
          <div>
            <p className="text-gray-200">&copy; MIguel Luna. All Rights Reserved.</p>
          </div>
